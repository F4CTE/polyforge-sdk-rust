...
This project is indexed by GitNexus as **polyforge-sdk-rust** (652 symbols, 1666 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/polyforge-sdk-rust/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/polyforge-sdk-rust/context` | Codebase overview, check index freshness |
| `gitnexus://repo/polyforge-sdk-rust/clusters` | All functional areas |
| `gitnexus://repo/polyforge-sdk-rust/processes` | All execution flows |
| `gitnexus://repo/polyforge-sdk-rust/process/{name}` | Step-by-step execution trace |
